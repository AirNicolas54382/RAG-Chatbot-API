...
class RAGService:
    ...
    def _build_chain(self):
        ...
        system_prompt = (
            "Jesteś pomocnym asystentem AI. Odpowiedz na pytanie użytkownika "
...
# 2. Łączymy model z promptem i dokumentami (chain odpowiadający za odpowiedź)
        question_answer_chain = create_stuff_documents_chain(self.llm, prompt)
# 3. Łączymy wyszukiwarkę (retriever) z łańcuchem odpowiedzi
